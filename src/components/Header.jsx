    ...
    >
      ...
      <section className="flex justify-evenly items-center md:mb-10 md:w-full">
        <img
          ...
          alt="Kayathiri"
        />
        <h1 className=" text-center text-xl md:text-lg xl:text-xl text-slate-50 font-display font-semibold tracking-wide ml-4">Kayathiri
        </h1>
      </section>
      {/* Navbar */}
      ...
      <ul className="footer-links hidden w-full md:flex justify-evenly items-center">
        ...
        <a
          ...
          href="https://www.linkedin.com/in/r-kayathiri-r-a2473218a/"
          target="_blank"
          rel="noreferrer"
          name="Link to kayathiri's LinkedIn"
        >
        ...
        <a
          ...
          href="https://github.com/kayathiriramesh"
          target="_blank"
          rel="noreferrer"
