  ...
  return (
    ...
    <div class="contact-box">
      <div class="contact-links">
        <h2>Contact</h2>
          <p> <a href="mailto:meltee@live.com" class="contact-info text-2xl mt-10"> kayu.uma18@gmail.com</a> </p>
          <p class="contact-info text-2xl mt-10"> 8015215244</p>
        <div class="links my-10">

          <a href="https://www.linkedin.com/in/r-kayathiri-r-a2473218a/" target="blank" class="links">
              <img src={linkedinsvg} alt="linkedin" class="contactimg" />
          </a>
      
          <a href="https://github.com/kayathiriramesh" target="blank" class="links">
